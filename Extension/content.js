let gameSidebar, startBetButton, statusSpan, betAmountInput, profitInput, cashoutInput;
let statusCheckInterval;
let autoBetRunning = false;
let lastStatus = '';

function initializeElements() {
  gameSidebar = document.querySelector("[data-testid='game-frame'] .game-sidebar");
  startBetButton = document.querySelector("[data-testid='game-frame'] .game-sidebar > button");
  statusSpan = startBetButton?.querySelector("span");
  betAmountInput = document.querySelector("[data-testid='game-frame'] [data-testid='input-game-amount']");
  profitInput = document.querySelector("[data-testid='game-frame'] [data-testid='profit-input']");
  cashoutInput = [...(gameSidebar?.querySelectorAll("label span[slot='label']") || [])]
